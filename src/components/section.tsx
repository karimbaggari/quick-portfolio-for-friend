    ...
    <div className={`py-6 sm:py-8 lg:py-12 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <div className={`mx-auto max-w-screen-2xl px-4 md:px-8 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
        <div className="mb-6 flex items-end justify-between gap-4">
          ...
          <a href="#" className={`inline-block rounded-lg border ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-500'} px-4 py-2 text-center text-sm font-semibold outline-none ring-indigo-300 transition duration-100 hover:bg-gray-600 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base`}>Show more</a>
        </div>
